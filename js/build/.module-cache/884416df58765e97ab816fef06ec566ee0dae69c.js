      ...
      React.createElement("div", {className: "row"}, 
        React.createElement("form", {className: "col-md-4 col-centered box"}, 
          ...
          React.createElement("div", {className: "btn-group-vertical text-left clearfix"}, 
            React.createElement("button", {className: "btn btn-primary"}, "Time working on visual effects for movie", React.createElement("i", {className: "glyphicon glyphicon-ok pull-right"})), 
