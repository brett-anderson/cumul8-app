      ...
      React.createElement("div", {className: "row"}, 
        React.createElement("form", {className: "col-md-4 col-centered box"}, 
          ...
          React.createElement("div", {className: "btn-group-vertical"}, 
            React.createElement("button", {className: "btn btn-primary  btn-block"}, "Time working on visual effects for movie"), 
            React.createElement("button", {className: "btn btn-primary  btn-block"}, "Time spent reviewing the work of a junior artist")
          )
        )
      )
    )
