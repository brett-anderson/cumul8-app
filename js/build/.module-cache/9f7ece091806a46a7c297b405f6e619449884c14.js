    ...
    return (
      React.createElement("div", {className: "row"}, 
        React.createElement("form", {className: "col-md-4 col-centered box"}, 
          React.createElement(InputContainer, {placeholder: "email:", type: "email", value: this.state.email}), 
          React.createElement(InputContainer, {placeholder: "time:", value: this.state.time}), 
          React.createElement(InputContainer, {textarea: true, placeholder: "message (optional):", value: this.state.message}), 
          ...
          React.createElement("div", {className: "form-actions clearfix"}, 
            React.createElement("button", {className: "btn btn-primary pull-left", onClick: clearForm}, "Clear Form "), 
