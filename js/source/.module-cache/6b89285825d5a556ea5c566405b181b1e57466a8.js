      ...
      React.createElement("div", {className: "row"}, 
        React.createElement("form", {className: "col-md-4 col-centered box"}, 
          ...
          React.createElement("div", {className: "btn-group-vertical text-left clearfix"}, 
            React.createElement("button", {className: "btn btn-primary", onClick: this.setState({type: 1})}, "Time working on visual effects for movie", (type == 1) ? CheckIcon : ''), 
            React.createElement("button", {className: "btn btn-primary", onClick: this.setState({type: 2})}, "Time spent reviewing the work of a junior artist", (type == 2) ? CheckIcon : '')
          ), 
