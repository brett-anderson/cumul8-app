      ...
      React.createElement("div", {className: "row"}, 
        React.createElement("form", {className: "col-md-4 col-centered box"}, 
          ...
          React.createElement("div", {className: "form-actions clearfix"}, 
            ...
            React.createElement("button", {className: "btn btn-primary pull-left", onClick: this.validateForm}, "go! "), 
            React.createElement(Link, {className: "btn btn-primary pull-right", to: "valid"}, "Submit")
          )
        )
      )
    )
