      ...
      React.createElement("div", {className: "row"}, 
        React.createElement("form", {className: "col-md-4 col-centered box"}, 
          ...
          React.createElement("div", {className: "btn-group text-left clearfix", dataToggle: "buttons"}, 
            ...
            React.createElement("label", {className: "btn btn-primary"}, React.createElement("input", {type: "radio", name: "type", autocomplete: "off", onClick: this.handleClick}), "Time spent reviewing the work of a junior artist")
          ), 
