      ...
      React.createElement("div", {className: "row"}, 
        React.createElement("form", {className: "col-md-4 col-centered box"}, 
          ...
          React.createElement("div", {className: "btn-group text-left clearfix", dataToggle: "buttons"}, 
            React.createElement("label", {className: "btn btn-primary"}, React.createElement("input", {type: "radio", name: "type", id: "working", autoComplete: "off", onClick: this.handleClick}), "Time working on visual effects for movie"), 
            React.createElement("label", {className: "btn btn-primary"}, React.createElement("input", {type: "radio", name: "type", id: "reviewing", autoComplete: "off", onClick: this.handleClick}), "Time spent reviewing the work of a junior artist")
          ), 
