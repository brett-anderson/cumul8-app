      ...
      React.createElement("div", {className: "row"}, 
        React.createElement("form", {className: "col-md-4 col-centered box"}, 
          ...
          React.createElement("div", {className: "form-actions clearfix"}, 
            ...
            React.createElement("button", {className: "btn btn-primary pull-right", disabled: !this.state.emailValid || !this.state.timeValid || this.state.type == false, onSubmit: this.handleSubmit}, "Submit")
          )
        )
      )
    )
