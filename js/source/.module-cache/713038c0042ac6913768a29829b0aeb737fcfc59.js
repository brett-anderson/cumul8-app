...
InputContainer = React.createClass({displayName: "InputContainer",
  ...
  render: function() {
    ...
    if(this.props.textarea) {
      ...
      Input = React.createElement("input", {type: this.props.type, className: "form-control", placeholder: this.state.placeholder, onFocus: this.handleFocus, onBlur: this.handleBlur})
    }
    return (
